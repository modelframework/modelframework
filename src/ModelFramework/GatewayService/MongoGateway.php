...
//        if (
//            ( $object = $this->resultSetPrototype->getArrayObjectPrototype() ) instanceof DataModelInterface
//            && method_exists( $object, 'getFieldNames' )
//            && is_array( $columns = $object->getFieldNames() )
//        )
//        {
